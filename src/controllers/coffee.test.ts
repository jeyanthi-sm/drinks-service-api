...
response which includes two properties: the drinkType set to “Coffee” 
and name set to the provided name
*/
...
describe("Test coffee endpoint request with query Espresso", () => {
  test("GET should return correct message", async () => {
    ...
    expect(res.body).toEqual({ drinkType: "Coffee", name: "Espresso" });
  });
});
